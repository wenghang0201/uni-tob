	...
	<view class="bind-alipay-page">
		...
		<view class="nav-header">
			...
			<view class="nav-center">
				<text class="nav-title">绑定支付宝账号</text>
			</view>
		...
		<view class="content-area">
			...
			<view class="title-section">
				...
				<text class="title-text">绑定支付宝账号</text>
			</view>
