<template>
	<view class="box">
		<nav-bar :title="'用户'" :back="true"></nav-bar>
			...
			<view class="list-cell b-b m-t" v-for="(vo,customersindex) in complaints" :key="customersindex"   hover-class="cell-hover" :hover-stay-time="50" @click="detail(vo)">
				<image :src="vo.avatar" mode="scaleToFill" border="0" class="my_65"></image>
				<text class="cell-tit">
					{{vo.storeRemark || vo.nickname}}
