	...
	<view class="box" style="">
		...
		<view class="user_info">
			...
			<view style="margin-left: 70px;">
				<span >{{user.storeRemark || user.nickname}}</span>
				- <span >{{user.shop_name}}</span>
				<br>
				<span style="font-size:9px;">联系方式：{{user.phone}}</span>
				<br>
				<span style="font-size:9px;">绑定时间：{{user.createTime}}</span>
			</view>
		</view>
		...
		<view class="tongji" >
			...
			<view class="tongji_mix">
				...
				<view class="mx_info">
					<span class="mx_title">总余额</span>
					<br>
					<span class="mx_content">{{user.balance}}</span>
				</view>
				<view class="mx_info">
					<span class="mx_title">可提现余额</span>
					<br>
					<span class="mx_content">{{user.gold}}</span>
				</view>
				<view class="mx_info">
					<span class="mx_title">不可提现余额</span>
					<br>
					<span class="mx_content">{{user.price}}</span>
				</view>
			</view>
			<view class="tongji_mix">
				<view class="mx_info">
