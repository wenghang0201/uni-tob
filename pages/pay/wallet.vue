	...
	<view class="content-wrap box">
		...
		<u-sticky>
			...
			<view class="nav-wrap">
				...
				<view class="item" @click="handleToPage('/pages/pay/paymentManagement')">
					<view>
						<image src="@/static/images/wallet/setting.png" />
					</view>
					<text>收款管理</text>
				</view>
			</view>
		...
		<view class="list-wrap">
			<view class="card">
				...
				<u-empty icon="/static/nodata.png" :show="payOrderList.length<=0" mode="data"
					text="没有交易记录"></u-empty>
